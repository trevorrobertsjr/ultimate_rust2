...
impl Frog {
    ...
    pub fn hop(&mut self) {
        ...
        info!(target:"Frog::hop","Frog hopped, and {} energy is left", self.energy);
        if self.energy == 0 {
            // 4. Use warn!() to warn that the frog will go to sleep since he ran out of energy
            warn!(target:"Frog::hop","frog will go to sleep since he ran out of energy");
            self.sleep();
        }
    }
...
impl Default for Frog {
    fn default() -> Self {
        ...
        trace!(target:"Frog::default","A default value was generated, with the debug representation");
        Frog {
            energy: 5,
            sleeping: false,
        }
